...
<body class="antialiased text-gray-300 bg-black">
    <div class="container py-10 mx-auto">
        <img src="{{ url('/img/logo.svg') }}" alt="4shack.org" width="200px" class="mb-6">

        <h1 class="mb-6 text-2xl">La fin de NoelShack pour les JVlikes</h1>
        ...
        <blockquote class="pl-3 mb-6 border-l-4 border-gray-800">
        ...
        <h1 class="mb-6 text-2xl">Comment utiliser 4shack.org</h1>
        ...
        <div>
            <span class="inline-block p-3 mb-6 bg-gray-900 rounded">
        ...
        <h1 class="mb-6 text-2xl">Extension pour navigateur</h1>
        ...
        <p class="mb-6">
            <a href="https://github.com/sucresware/4shack-userscript/raw/master/4shack.user.js" class="underline" target="_blank">Ajouter le script</a>
            <a href="https://github.com/sucresware/4shack-userscript" class="underline" target="_blank">Guide d'installation</a>
        </p>

        <h1 class="mb-6 text-2xl">À propos de 4shack.org</h1>
